...
* [latest stable version](https://github.com/selliott512/wad-tweak/archive/0.9.1.zip) (recommended)
...
```shell
unzip wad-tweak-0.9.1.zip
wad-tweak-0.9.1/bin/wad-to-lump.py ...
wad-tweak-0.9.1/bin/wad-shuffle-dir.py ...
```
...
```shell
unzip -d /opt wad-tweak-0.9.1.zip # Requires root.
PATH="$PATH:/opt/wad-tweak-0.9.1/bin"
wad-to-lump.py ...
wad-shuffle-dir.py ...
```
